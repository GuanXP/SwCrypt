...
open class SwKeyStore {
    ...
    public enum SecError: OSStatus, Error {
        ...
        init(_ status: OSStatus, function: String = #function, file: String = #file, line: Int = #line) {
            self = SecError(rawValue: status) ?? .unimplemented
    ...
    public static func upsertKey(_ pemKey: String,
                                 keyTag: String,
...
open class SwKeyConvert {
    ...
    open class PrivateKey {
        ...
        public static func encryptPEM(_ pemKey: String,
                                      passphrase: String,
...
open class CC {
    ...
    public enum CCError: CCCryptorStatus, Error {
        ...
        init(
            ...
            file: String = #file, line: Int = #line) {
                ...
                self = CCError(rawValue: status) ?? .decodeError
    ...
    public static func cryptAuth(
        _ opMode: OpMode,
        blockMode: AuthBlockMode,
        algorithm: Algorithm,
        data: Data,
        aData: Data,
    ...
    fileprivate typealias CCLong = UInt32
    ...
    open class DH {
        ...
        fileprivate typealias KeyCCDHRFC3526Group5TM = UnsafePointer<CCDHParameters>
        fileprivate static let KeyCCDHRFC3526Group5M: KeyCCDHRFC3526Group5TM? =
            getFunc(dl!, f: "kCCDHRFC3526Group5")
        fileprivate static let kCCDHRFC3526Group5 = KeyCCDHRFC3526Group5M?.pointee

        fileprivate typealias KeyCCDHRFC2409Group2TM = UnsafePointer<CCDHParameters>
        fileprivate static let kCCDHRFC2409Group2M: KeyCCDHRFC2409Group2TM? =
